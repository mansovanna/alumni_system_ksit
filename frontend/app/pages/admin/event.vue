...
const handlePayloadRestPass = (data) => {
  console.log(data);
};
</script>
...
<template>
  <!--  -->
  <AdminsEventAdd v-if="formAddNew" @close="formAddNew = false" />
  <AdminsEventUpdate
    v-if="formUpdate"
      ...
      >
        <thead class="w-full font-normal">
          <tr class="bg-ab">
            ...
            <th
              class="font-normal px-4 py-3 text-sm text-slate-600 text-left w-30"
            >
              Date
            </th>

            <th
              class="font-normal px-4 py-3 text-sm text-slate-600 text-center w-15"
            >
              Member
            </th>
        ...
        <tbody>
          <tr v-for="index in 5" class="hover:bg-slate-100">
            <th
            ...
            <th
              class="font-normal px-4 py-1.5 text-sm text-slate-600 text-left"
            >
              សូមអញ្ជើញអតីតនិស្សិតទាំងអស់ធ្វើបច្ចុប្បន្នភាពព័ត៌មានការងារ
            </th>

            <th
              class="font-normal px-4 py-1.5 text-sm text-slate-600 text-center"
            >
              30-06-2026
            </th>
            ...
            <th
              class="font-normal px-4 py-1.5 text-sm text-slate-600 text-center flex justify-center items-center"
            >
              <div class="flex justify-end items-center gap-2">
                <button
                  @click="handleUpdate(index, 'Computer of Technology')"
